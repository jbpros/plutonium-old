...
Assembler.prototype.assembleApp = function () {
  ...
  var eventStore       = new EventStore(this.configuration.domain.uri);
...
Assembler.prototype.loadReporters = function () {
  ...
  reportersSettings.forEach(function (reporterSettings) {
    ...
    var Reporter = reporterSettings.ctor;
    // todo: instantiate reporter (after reports and reporters were decoupled)
    Reporter.initialize({
